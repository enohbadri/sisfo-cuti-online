...
<page>
        ...
        <?php
		$sql1 = mysql_query("SELECT a.nik, a.nama, a.no_tlp, a.jkelamin, b.nama AS cabang_id FROM pegawai a, departemen b WHERE a.id='$_GET[pgid] AND a.cabang_id=b.id'");
		...
		<table border="0" style="font-size: 16px; border-collapse: collapse; width: 100%;">
			<tr><td>NRK </td><td>&nbsp; : &nbsp;</td><td><?php echo $ro['nik']; ?></td></tr>
			<tr><td>Nama </td><td>&nbsp; : &nbsp;</td><td><?php echo $ro['nama']; ?></td></tr>
			<tr><td>Departemen </td><td>&nbsp; : &nbsp;</td><td><?php echo $ro['cabang_id']; ?></td></tr>
			<tr><td>Jenis Cuti</td><td>&nbsp; : &nbsp;</td><td><?php echo $ro['cabang_id']; ?></td></tr>
